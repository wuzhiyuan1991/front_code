                    ...
                    <div class="p-report-box">
                        ...
                        <div class="p-report-wrap" style="min-height:200px">
                            ...
                            <div class="i-report-info">
                                <p class="fsize16 c-666 hLh30">得分：<span class="c-333"><fmt:formatNumber value="${paperRecord.userScore }" pattern="#0"
                                                                                                        type="number" minFractionDigits="0"></fmt:formatNumber> 总分：${paperRecord.examPaper.score }</span>
                                </p>
                                <p class="fsize16 c-666 hLh30">答题时长：
                                    <span class="c-333">
									<c:choose>
                                        <c:when test="${paperRecord.testTime != null }">
                                            <fmt:formatNumber value="${(paperRecord.testTime-paperRecord.testTime%60)/60}" pattern="#0" type="number"
                                    ...
                                    <li class="datikaQstAnchor<c:out value="${questionNumIndex} p-q-item"/>">
                                        <div class=" p-ques-title">
                                            ...
                                            <span class="c-master fsize16 ml10">
													...
													</span><span class="c-666 fsize16">${qstMiddle.question.content }</span>
                                        </div>
                                        <section class="t-p-options">
                                            <ol>
                                                ...
                                                <c:if test="${qstMiddle.question.type==2}">
                                                    <c:forEach items="${qstMiddle.question.opts}" var="option">
                                                        <li class="mul-options-item<c:if test="${qstMiddle.answer.indexOf(option.opt) > -1}"> mul-options-item__right</c:if><c:if test="${qstMiddle.userAnswer.indexOf(option.opt) > -1 && qstMiddle.answer.indexOf(option.opt) == -1}"> mul-options-item__error</c:if>">
                                                ...
                                                <%--</c:if>--%>
                                                <%--<c:if test="${qstMiddle.question.type==3}">--%>
                                                    <%--<li><a href="javascript:void(0);">A、正确</a></li>--%>
                                                    <%--<li><a href="javascript:void(0);">B、错误</a></li>--%>
                                                <%--</c:if>--%>
                                            </ol>
                                            <a href="javascript:void(0);" onclick="showDeleteErrorRecordModal('${qstMiddle.question.id}')" class="t-e-delete-btn">删除错题</a>
                                        </section>
                                        <section class="bg-fa">
