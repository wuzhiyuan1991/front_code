				...
				<div class="col18 fl pr">
					<div class="p-test-box" id="p-test-box">
						<c:if test="${not empty topicList}">
							<dl class="paper-test">
								<dt><a href="javascript:window.close()" title="" style=" color: #999; font-size: 16px;line-height: 36px;"><em class="dtback vam"></em>关闭</a></dt>
								<dd><input type="checkbox" class="vam" onclick="danti(this)" id="checkboxdanti"> <a href="javascript:void(0)" title="" class="vam">单题模式</a></dd>
							</dl>
						</c:if>
						<!-- /答题卡 开始 -->
