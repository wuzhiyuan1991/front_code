    ...
    $("#lh-menu>ul>li>a").each(function() {
        ...
        _this.click(function() {
            if (_this.siblings("ol").is(":hidden")) {
                ...
                _this.parent("li").siblings().children("a").removeClass("current-1");
...
function dialog(dTitle,msg,index,url) {
    ...
    var dCont = [
            ...
            "<div class='d-tips-1'><em class='pa d-t-icon-3'></em><p class='fsize14 c-666'>"+msg+"</p><div class='tac mt30'><a href='"+url+"' title='' class='order-submit dClose' target='_blank'>确定</a><a href='javascript:void(0)' title='' class='goBack-btn ml10 dClose'>取消</a></div></div>",
					...
					var useImg="";
	 				...
	 				for(var i=0;i<resultList.length;i++){
	 					...
	 					if(useImg==null || $.trim(useImg)==''){
	 						...
	 						useImg =fileServerContextPath+useImg;
	 					}
	 					...
	 					if(userShowName==null || $.trim(userShowName)==''){
	 						var mobile = resultList[i].userMobile;
	 						if(mobile!=null && $.trim(mobile)!=''){
	 							userShowName = resultList[i].userMobile.substring(0,3)+"****"+resultList[i].userMobile.substring(7);
	 						}else{
	 							userShowName="";
	 						}
