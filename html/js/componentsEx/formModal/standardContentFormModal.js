define(function(require){
	var LIB = require('lib');
 	//数据模型
	var tpl = require("text!./standardContentFormModal.html");
	var api = require("views/businessFiles/complianceManager/standard/vuex/api")
	//初始化数据模型
	var newVO = function() {
		return {
            id: null,
	...
	var detail = LIB.Vue.extend({
		...
		methods:{
            ...
            afterInit: function () {
                ...
                this.mainModel.vo.standardChapter.id = this.chapter[0].id
                this.mainModel.vo.standardChapter.name = this.chapter[0].name
