define(function (require) {
    var LIB = require('lib');
    //数据模型
    var tpl = require("text!./lawsContentFormModal.html");
    ...
    var dataModel = {
        mainModel: {
            ...
            //验证规则
            rules: {
                'lawsChapter.id': [LIB.formRuleMgr.require("章节"),],
    ...
    var detail = LIB.Vue.extend({
        ...
        methods: {
            ...
            afterInit: function () {
                ...
                this.mainModel.vo.lawsChapter.id = this.chapter[0].id
                this.mainModel.vo.lawsChapter.name = this.chapter[0].name
