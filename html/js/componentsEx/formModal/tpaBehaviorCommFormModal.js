define(function(require){
	var LIB = require('lib');
 	//数据模型
	var tpl = require("text!./tpaBehaviorCommFormModal.html");
	...
	var dataModel = {
		mainModel : {
	        ...
	        rules:{
				...
				"isRectification" : [LIB.formRuleMgr.require("是否现场立即整改"),
						  LIB.formRuleMgr.length()
				],
				...
				"step" : [LIB.formRuleMgr.length()],
				"suggestStep" : [LIB.formRuleMgr.length()],
				"talkResult" : [LIB.formRuleMgr.length()],
