define(function (require) {
  return {
    ...
    "iam_casualty_affiliation": [{
      "1": "管理局员工"
    }, {
      "2": "承包商员工"
    }],
    "risk_hse_evalu_method": [{
      "1": "LEC"
    }],
    "shareType": [{
      "1006": "文字"
    ...
    "itm_cert_is_recheck_required": [{
      "1": "需要"
    }, {
      "0": "不需要"
    }],
    "iem_maint_record_type": [{
      "1": "检修抢修"
    }, {
      "2": "维护保养"
    }],
    ...
    "iri_check_result_is_right": [{
      "0": "错误"
    }, {
      "1": "正确"
    }],
    "asmt_task_auditSource": [{
      "0": "系统到期提交"
    }, {
      "1": "用户手动提交"
    }],
    ...
    "isr_responsibility_type": [{
      "1": "岗位"
    }, {
      "2": "部门"
    }],
    "iem_exercise_scheme_form": [{
      "1": "桌面推演"
    }, {
      "2": "现场演习"
    }],
