...
require(['jquery', 'app/app', 'text', 'lodash', 'base', 'const', 'bootstrap',
        'popper', "underscoreDeepExtend", 'mousewheel', 'vue', 'vueRouter', 'artTempalte', 'apiCfg', 'iconfont','chart2','graphEditor','popper1'],
    function ($, app, TEXT, LODASH, BASE, CONST, BJS,
              popper, underscoreDeepExtend, mousewheel, vue, vueRouter, artTempalte, apiCfg, iconfont,chart2,graphEditor,popper1) {
