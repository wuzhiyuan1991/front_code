define(function(require){
	...
	var dataModel = {
		...
		formModel : {
			...
			idaDutySubjectFormModel : {
				show : false,
				queryUrl : "idadutysubject/{id}"
			}
		},
		cardModel : {
			dutyAbilityCardModel : {
				showContent : true
			},
			userCardModel : {
				showContent : true
	...
	var detail = LIB.Vue.extend({
		...
		methods:{
			...
			doShowIdaDutySubjectFormModal4Update : function(data) {
				this.formModel.idaDutySubjectFormModel.show = true;
				this.$refs.idadutysubjectFormModal.init("update", {id: this.mainModel.vo.id});
			},
			doUpdateIdaDutySubject : function(data) {
				this.doUpdate(data);
			},
