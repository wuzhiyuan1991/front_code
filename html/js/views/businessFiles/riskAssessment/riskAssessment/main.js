define(function (require) {
            ...
            tableModel: LIB.Opts.extendMainTableOpt(renderTableModel(
                {
                    ...
                    columns: [
                        ...
                        {
                            title: '危害因素',
                            fieldName: "hazardFactor.name",
                            filterType: 'text',
                            orderName: "hazardFactor.name",
                            filterName: "criteria.strValue.hazardFactorName",
                            width: 160
                        },
                        //{
    ...
    var vm = LIB.VueEx.extend({
        ...
        methods: {
            ...
            //根据当前的搜索条件导出数据到Excel
            doExportRiskPoint: function() {
                LIB.Modal.confirm({
                    title: '导出风险点清单?',
                    onOk: function() {
                        window.open("/riskassessment/exportRiskPoint");
                    }
                });
            },
        },
