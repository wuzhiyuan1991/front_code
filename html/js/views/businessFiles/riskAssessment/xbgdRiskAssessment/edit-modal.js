define(function (require) {
    ...
    var dataModel = {
        ...
        rules: {
            ...
            'bizType':[
                {required: true, message: '请选择风险数据来源'}
            ],
            'evaluMethod':[
                {required: true, message: '请选择评估方法'}
            ],
            controlMeasures: [
                LIB.formRuleMgr.length(1000),
                {
    ...
    var detail = LIB.Vue.extend({
        ...
        watch: {
            ...
            'mainModel.vo.bizType':function(newval,old) {
                if(old){

                    this.mainModel.vo.evaluMethod = null;
                }
            },
        },
        methods: {
        ...
        events: {
            ...
            "ev_editReload": function (nVal) {
                ...
                if (nVal) {
                    ...
                    if (bizType) {
                        _this.mainModel.vo.bizType = bizType;
                    } else {
                        _this.mainModel.vo.bizType = "1";
                    }
                    this._initCreate();
                }
            }
