define(function(require){
    ...
    var customActions = {
		...
		removeRiskItems : _.extend({method: 'DELETE', url: 'riskitem'}, apiCfg.delCfg),
        updateRiskItem : {method: 'PUT', url: 'riskitem'},
       ...
       doSubmit: {method: 'GET', url: 'changemanagement/riskItemUpdateAttr5'},
