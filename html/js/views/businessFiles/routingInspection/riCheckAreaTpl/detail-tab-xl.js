define(function(require){
	...
	var riCheckAreaTplFormModal = require("componentsEx/formModal/riCheckAreaTplFormModal");
	...
	var dataModel = {
		...
		formModel : {
			riCheckAreaTplFormModel : {
				show : false,
				queryUrl : "richeckareatpl/{id}"
			}
		},
		cardModel : {
		},
	...
	var detail = LIB.Vue.extend({
		...
		components : {
			...
			"richeckareatplFormModal":riCheckAreaTplFormModal,
		...
		methods:{
			...
			doShowRiCheckAreaTplFormModal4Update : function(data) {
				this.formModel.riCheckAreaTplFormModel.show = true;
				this.$refs.richeckareatplFormModal.init("update", {id: this.mainModel.vo.id});
			},
			doUpdateRiCheckAreaTpl : function(data) {
				this.doUpdate(data);
			},
