define(function(require){
	...
	var detail = LIB.Vue.extend({
		...
		methods:{
			...
			doShowCheckObjectFormModal4Update : function(data) {
				this.formModel.checkObjectFormModel.show = true;
				this.$refs.checkobjectFormModal.init("update", {id: this.mainModel.vo.id});
			},
			doUpdateCheckObject : function(data) {
				this.doUpdate(data);
			},
