...
define(function (require) {
    ...
    var dataModel = {
        mainModel: {
            ...
            //验证规则
            rules: {
                name: [{required: true, message: '请输入工作表名称'},
                    LIB.formRuleMgr.length(100)
                ],
                type: [{required: true, message: '请选择工作表类型'}],
                compId: [{required: true, message: '请选择所属公司'}],
                disable: [{required: true, message: '请选择工作表状态'}],
    ...
    var detail = LIB.Vue.extend({
        ...
        methods: {
            ...
            doShowCourseSelectModal : function() {
                ...
                this.selectModel.courseSelectModel.filterData = {type: 1, disable: 0};
            },
            ...
            doSaveCheckItem: function (data) {
                ...
                this.mainModel.vo.checkItem.bizType = 'job';
