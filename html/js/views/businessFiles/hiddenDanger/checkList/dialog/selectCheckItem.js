define(function (require) {
                ...
                render: function (data) {
                	if(data.riskAssessments){
                        ...
                        data.riskAssessments.forEach(function (e) {
                            if(e.riskPoint && riskPoints.indexOf(e.riskPoint+ " , ")==-1){
    ...
    var selectDialog = LIB.Vue.extend({
        ...
        events: {
            //select框数据加载
            "ev_selectItemReload": function (checkTable, tir,isShowEquipInspection) {
                var columns = dataModel.checkItemColumns;
                var attr2 = "0";
                if (isShowEquipInspection == true) {
                    attr2 = "1";
                ...
                var params = [
	                  ...
	                  },
                    {
                        type: "save",
                        value: {
                            columnFilterName: "attr2",
                            columnFilterValue: attr2
                        }
                    },
                    {
                        type: "save",
