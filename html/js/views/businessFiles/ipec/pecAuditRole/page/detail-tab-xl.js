define(function(require){
	...
	var detail = LIB.Vue.extend({
		...
		methods:{
			...
			doShowPecAuditRoleFormModal4Update : function(data) {
				this.formModel.pecAuditRoleFormModel.show = true;
				this.$refs.pecauditroleFormModal.init("update", {id: this.mainModel.vo.id});
			},
			doUpdatePecAuditRole : function(data) {
				this.doUpdate(data);
			},
