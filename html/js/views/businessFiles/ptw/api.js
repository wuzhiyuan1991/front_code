...
var resource = Vue.resource(null,{}, customActions);
    return  _.extend({}, {
        getWorkCatalogLevelList:function(obj){
            return    this.getWorkCatalogs(obj).then(function (data) {
                var params = _.extend((obj || {}),{type:2})
                return   resource.listCatalogs(params).then(function (levelListRes) {
