define(function(require){
	...
	var detail = LIB.Vue.extend({
		...
		methods:{
			...
			doShowTpaCheckItemFormModal4Update : function(data) {
				this.formModel.tpaCheckItemFormModel.show = true;
				this.$refs.tpacheckitemFormModal.init("update", {id: this.mainModel.vo.id});
			},
			doUpdateTpaCheckItem : function(data) {
				this.doUpdate(data);
			},
