define(function(require){
	...
	var dataModel = {
		...
		formModel : {
			tpaBoatEquipmentItemFormModel : {
				show : false,
				queryUrl : "tpaboatequipmentitem/{id}"
			}
		},
		cardModel : {
		},
	...
	var detail = LIB.Vue.extend({
		...
		methods:{
			...
			doShowTpaBoatEquipmentItemFormModal4Update : function(data) {
				this.formModel.tpaBoatEquipmentItemFormModel.show = true;
				this.$refs.tpaboatequipmentitemFormModal.init("update", {id: this.mainModel.vo.id});
			},
