define(function (require) {
    ...
    var initDataModel = function () {
        return {
            ...
            uploadModel: {
                url: "/opmaintcard/importExcel"
            },
            exportModel: {
                url: "/opmaintcard/exportExcel",
                withColumnCfgParam: true
            },
            templete: {
                url: "/opmaintcard/file/down"
            },
    ...
    var vm = LIB.VueEx.extend({
        ...
        methods: {
            doJSA: function () {
                ...
                var routerPart = "/jse/businessCenter/jsaMasterNew?method=create&type=2&cardId=" + row.id;
            ...
            _getUndoCount: function () {
                ...
                api.getUndoCount().then(function (res) {
                    _this.undoCount = _.get(res.data, '2', 0);
                })
            },
