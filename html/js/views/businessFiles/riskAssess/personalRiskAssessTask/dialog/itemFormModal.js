define(function (require) {
    ...
    var newVO = function () {
        return {
            checkResult: '1',
            recordId: null, // 记录ID
            riskAssessId: null,//         安全承诺书id
            riskAssessTaskId: null,//     任务id
            evaluate: null,//     评价
            id: null,//     项id
            groupId: null,//     组id
            groupName: null,//     组名
            ...
            cloudFiles: [],
            problem: null,  // 问题描述
            latentDefect: null, // 可能存在的危害
            suggestStep: null  // 建议措施
        }
    };
    ...
    var dataModel = function () {
        return {
            mainModel: {
                ...
                vo: newVO(),
                rules: {
                    "checkResult": [LIB.formRuleMgr.require("检查情况")],
                    "problem": [LIB.formRuleMgr.require("问题描述"), LIB.formRuleMgr.length(1000)],
                    "latentDefect": [LIB.formRuleMgr.length(500)],
                    "suggestStep": [LIB.formRuleMgr.length(500)]
                }
            },
            uploadModel: {
                params: {
    ...
    var opts = {
        ...
        methods: {
            init: function (params) {
                ...
                this.mainModel.vo.checkResult = this.mainModel.vo.checkResult || '1';
