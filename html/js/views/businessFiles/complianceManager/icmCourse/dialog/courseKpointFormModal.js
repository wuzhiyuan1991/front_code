define(function (require) {
    ...
    // var swfobject ;//= require('views/businessFiles/trainingManagement/course/uploadify/swfobject');
    // var uploadify ;//= require('views/businessFiles/trainingManagement/course/uploadify/jquery.uploadify.min.v3.2.1');
    //数据模型
    var tpl = require("text!./courseKpointFormModal.html");
    ...
    var dataModel = {
        mainModel: {
            ...
            //验证规则
            rules: {
                "name": [LIB.formRuleMgr.require("目录名称"), LIB.formRuleMgr.length(1000, 1)],
                "kpointType": [{required: true, message: '请选择节点类型'}],
                "chapterName": [LIB.formRuleMgr.require("章节名称"), LIB.formRuleMgr.length(100, 1)],
                videoModel: [
                    {
...
//                     'swf': BASE.ctxpath + '/html/js/views/businessFiles/trainingManagement/course/uploadify/uploadify.v3.2.1.swf',
//                     'button_image_url': BASE.ctxpath + '/html/js/views/businessFiles/trainingManagement/course/uploadify/callback.png',
//                     'multi': true,
//                     'successTimeout': 1800,
//                     'queueSizeLimit': 1,
...
//             },
            ...
            init: function (opType, nVal) {
                ...
                if (nVal.id && nVal.id != null) {
                    //修改查询单个课程章节
                    api.queryCourseKpoint({id: nVal.courseId, icmcoursekpointId: nVal.id}).then(function (res) {
