		...
		methods: {
			...
			doEdit: function (data) {
				...
				if (this.type == 0) {
					...
					_this.users=data.entry.data.users
					// api.queryAuditRoles({ relId: data.entry.data.relId, relType: 2,  positionType:  this.mainModel.vo.type }).then(function (res) {
					// 	debugger
					// 	_.each(res.data,function(item){
