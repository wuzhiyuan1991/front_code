...
LIB.registerDataDic("iptw_stuff_type", [
    ...
    var initDataModel = function () {
        return {
            stuffTypeSelectedIndex:0,//作业角色人员下表
...
//			"ptwcatalogFormModal":ptwCatalogFormModal,
        ...
        methods: {
            ...
            doSelectGroup:function (index,item) {
                ...
                if("2,4,5".match(new RegExp(item.id))){return}
                this.getList();
            },
        ...
        route:{
            activate: function(transition) {
                ...
                if(this.$route.query.type){
                    this.checkedGroupIndex = this.$route.query.type;
                    this.$nextTick(function () {
                        _this.checkedGroupIndex = this.$route.query.type;
                        _this.tabList = this.getDataDicList('iptw_catalog_type');
                        _this.getList();
                    })
                }
