define(function (require) {
    ...
    var opts = {
        ...
        computed: {
            ...
            showTitle: function () {
                var titles = {
                    "frw": this.$t('gb.common.title.frw'),//"选择公司",
                    "dep": this.$t('gb.common.title.dep'),//"选择部门",
                    "per": this.$t('gb.common.title.per'),//"选择人员",
                    "equip": this.$t('gb.common.title.equip'),//"选择设备设施",
                    "teacher": this.$t('gb.common.title.teacher'),//"选择讲师",
                    "course": this.$t('gb.common.title.course'),//"选择课程",
                    "equipitem": this.$t('gb.common.title.equipitem'),//"选择设备设施子件"
                };
