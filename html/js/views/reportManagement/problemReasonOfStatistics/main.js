define(function(require) {
    ...
    var apiMap = {
            'frw':api.poolCountBySystemElementWithComp, 
            'dep':api.poolCountBySystemElementWithDep, 
        };
    ...
    var opt = {
        ...
        methods:{
            ...
            buildPieChart:function(data){
                var _this = this;
                var opt = {
                    title:{x:'center',text:'问题产生原因统计-饼状图', top: 20},
                ...
                var items = this.getDataDicList("pool_problem_reason");
                var ret = [];
            ...
            buildBarChart:function(data){
                var opt = {
                    title: {x: 'center', text: '问题产生原因统计', top: 20},
