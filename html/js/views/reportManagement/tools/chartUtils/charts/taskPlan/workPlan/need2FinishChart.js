...
define(function(require) {
    var LIB = require("lib");
    var api = require("./vuex/need2FinishChart-api");
    var template = require("text!./need2FinishChart.html");
    ...
    var dataModel = function(){
        return {
            apiMap:{
                'taskPlan-frw-org-1-1':api.compAbs,//计划执行-工作计划-应执行计划总数-公司-公司
                'taskPlan-frw-specialty-1-1':api.compSpecialty,//计划执行-工作计划-应执行计划总数-公司-专业
                'taskPlan-dep-org-1-1':api.depAbs,//计划执行-工作计划-应执行计划总数-部门-公司
                'taskPlan-dep-specialty-1-1':api.depSpecialty//计划执行-工作计划-应执行计划总数-部门-专业
            },
            charts:{
                opt:{
                    series:[]
