...
define(function(require) {
    ...
    var dataModel = function(){
        return {
            apiMap:{
                'taskPlan-frw-org-1-2':api.compAbs,//计划执行-工作计划-实际执行计划总数-公司-公司
                'taskPlan-frw-specialty-1-2':api.compSpecialty,//计划执行-工作计划-实际执行计划总数-公司-专业
                'taskPlan-dep-org-1-2':api.depAbs,//计划执行-工作计划-实际执行计划总数-部门-公司
                'taskPlan-dep-specialty-1-2':api.depSpecialty//计划执行-工作计划-实际执行计划总数-部门-专业
            },
            charts:{
                opt:{
                    series:[]
