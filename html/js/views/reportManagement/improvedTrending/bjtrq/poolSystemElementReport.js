define(function(require) {
    var LIB = require('lib');
    var template = require("text!./poolSystemElementReport.html");
    var dateUtils = require("../../tools/dateUtils");
    var dataUtils = require("../../tools/dataUtils");
    var api = require("./vuex/poolSystemElementReport-api");
    var components = {
    ...
    var opt = {
        ...
        methods:{
            ...
            buildPieChart:function(data){
                var opt = {
                    title:{x:'center',text:'体系要素隐患统计-饼状图'},
            ...
            doQry:function(){
                ...
                api.poolCountBySystemElement(qryParam).then(function(res){
