define(function(require) {
    var LIB = require('lib');
    var template = require("text!./poolInfoSourceReport.html");
    var dateUtils = require("../../tools/dateUtils");
    var dataUtils = require("../../tools/dataUtils");
    var api = require("./vuex/poolInfoSourceReport-api");
    var components = {
    ...
    var opt = {
        ...
        methods:{
            ...
            buildPieChart:function(data){
                var opt = {
                    title:{x:'center',text:'信息来源隐患统计-饼状图'},
            ...
            doQry:function(){
                ...
                api.poolCountByInfoSource(qryParam).then(function(res){
