define(function(require) {
    var LIB = require('lib');
    var template = require("text!./poolGradeReport.html");
    var dateUtils = require("../../tools/dateUtils");
    var dataUtils = require("../../tools/dataUtils");
    var api = require("./vuex/poolGradeReport-api");
    var components = {
    ...
    var opt = {
        ...
        methods:{
            ...
            doQry:function(){
                ...
                api.poolCountByRiskType(qryParam).then(function(res){
