    ...
    var buildDataModel = function () {
        ...
        return {
            ...
            drillModel: {
                ...
                title: "明细",
                //导出excel服务地址
                exportURL: '/rpt/iri/checktable/quantity/org/exportExcel',
                table: {
                    //数据请求地址
    ...
    var opt = {
        ...
        methods: {
            buildBarChart: function (data) {
                var opt = {
                    title: {x: 'center', text: '巡检表数量统计', top: 20},
            ...
            doQuery: function () {
                ...
                // });
                api.queryTableQuantityOrgAll(qryParam).then(function (res) {
            ...
            clickBarChart: function (v) {
                ...
                this.drillModel.table.url = '/rpt/iri/checktable/quantity/details/{curPage}/{pageSize}';
                this.drillModel.exportURL = '/rpt/jse/checktable/quantity/org/exportExcel';
