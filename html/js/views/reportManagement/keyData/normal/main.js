    ...
    var opt = {
        ...
        computed:{
            ...
            showResigned: function () {
                return this.qryInfoModel.vo.item && (this.qryInfoModel.vo.item[0] === 'person');
            }
        },
        methods:{
            changeItem:function(){
                ...
                this.qryInfoModel.vo.containResignedData = false;
            },
            ...
            _queryDataNumLimit: function () {
                ...
                qryInfoApi.queryDataNumLimit().then(function (res) {
                    ...
                    _this.loadQryParam(_this.qryInfoDetail);
                })
            }
        },
        created:function(){
