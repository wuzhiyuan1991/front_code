    ...
    var opt = {
        ...
        methods:{
            ...
            buildPieChart:function(data){
                var opt = {
                    title:{x:'center',text:'槽罐车作业安全巡检情况统计-饼状图',top:20},
            ...
            buildBarChart:function(data){
                var opt = {
                    title:{x:'center',text:'槽罐车作业安全巡检情况统计-柱状图',top:20},
            ...
            chartClick:function(params) {
                ...
                var tableOpt = {
                    url:"rpt/stats/tpa/checkrecord/car/checkresult/{curPage}/{pageSize}",
                    qryParam:qryParam,
                    filterColumns:["criteria.strValue.keyWordValue"],
                    columns:[
                        {title:"检查表名称",width:"150px",fieldName:"tpaCheckTable.name"},
                        {title:"船舶名称",width:"150px",fieldName:"attr1"},
                        {title:"检查时间",width:"150px",fieldName:"checkDate"}
                    ],
                }
                this.drillModel.table = tableOpt;
                this.drillModel.exportDataUrl = "/rpt/stats/tpa/checkrecord/car/checkresult/export";
