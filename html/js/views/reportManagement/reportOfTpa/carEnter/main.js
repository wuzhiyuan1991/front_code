    ...
    var opt = {
        ...
        methods:{
            ...
            chartClick:function(params) {
                ...
                //获取年
                var tableOpt = {
                    url:"rpt/stats/tpa/car/enter/detail/{curPage}/{pageSize}",
                    qryParam:qryParam,
                    filterColumns:["criteria.strValue.keyWordValue"],
                    columns:[
                        {title:"检查表",width:"280px",fieldName:"xValue"},
                        {title:"数量",width:"150px",fieldName:"yValue"},
                        {title:"设备名称",width:"150px",fieldName:"xName"},
                    ]
                };
                this.drillModel.table = tableOpt;
                this.drillModel.exportDataUrl = "/rpt/stats/tpa/car/enter/detail/export";
            ...
            buildBarChart:function(data){
                var opt = {
                    title:{x:'center',text:'槽罐车准入审查次数统计',top:20},
