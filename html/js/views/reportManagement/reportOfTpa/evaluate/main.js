    ...
    var opt = {
        ...
        methods:{
            ...
            buildPieChart:function(data){
                var opt = {
                    title:{x:'center',text:'船舶安全检查评价统计-饼状图',top:20},
            ...
            buildBarChart:function(data){
                var opt = {
                    title:{x:'center',text:'船舶安全检查评价统计-柱状图',top:20},
            ...
            chartClick:function(params) {
                ...
                var url = "rpt/stats/tpa/checkrecord/evaluate/{curPage}/{pageSize}?checkResult="+result;
                var tableOpt = {
                    url:url,
                    qryParam:qryParam,
                    columns:[
                        ...
                        {title:"船舶",width:"150px",fieldName:"equipmentName"}
                    ],
                }
