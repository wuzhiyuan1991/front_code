    ...
    var opt = {
        ...
        methods:{
            ...
            buildPieChart:function(data){
                var opt = {
                    title:{x:'center',text:'槽罐车二级安全审查检查情况统计-饼状图',top:20},
            ...
            buildBarChart:function(data){
                var opt = {
                    title:{x:'center',text:'槽罐车二级安全审查统计-柱状图',top:20},
            ...
            chartClick:function(params) {
                ...
                var tableOpt = {
                    ...
                    columns:[
                        ...
                        {title:"设备名称",width:"150px",fieldName:"attr1"},
