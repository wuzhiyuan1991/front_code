    ...
    var dataModel = function(){
        ...
        return {
            ...
            detailModel:{
                show:false,
                title:'明细',
                exportDataUrl:'/integralscorerecord/exportExcelRptDeptPerCapitaScoreData',
                table:{
                    url:'integralscorerecord/selectRptDeptPerCapitaScoreDetailPageData{/curPage}{/pageSize}',
                    qryParam:null,
                    filterColumns:["criteria.strValue.name","criteria.strValue.compName","criteria.strValue.deptName"],
                    columns:[
                        {
                            title: "名次",
                            fieldType:"sequence",
                        ...
                        {
                            title: "部门总人数",
                            fieldName: "totalPerson",
                            width: 150
                        },
                        // {
                        //     title: "检查人均得分",
                        //     fieldName: "checkScoreAvg",
                        //     width: 150
                        // },
                        // {
                        //     title: "立即整改人均得分",
                        //     fieldName: "ImmedReformScoreAvg",
                        //     width:150
                        // },
                        // {
                        //     title: "重大问题人均得分",
                        //     fieldName: "EffectiveProblemScoreAvg",
                        //     width:150
                        // },
                        // {
                        //     title: "随机观察人均得分",
                        //     fieldName: "RandomObservationAvg",
                        //     width:150
                        // },
                    ]
                }
    ...
    var opt = {
        ...
        methods:{
            ...
            showDetails:function(){
                this.detailModel.table.qryParam = _.deepExtend({type:1,orderType:'DeptPerCapitaScoreScore'}, this.getQryParam());
