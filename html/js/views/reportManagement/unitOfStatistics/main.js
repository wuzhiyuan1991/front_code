define(function(require) {
    ...
    var apiMap = {
        //'frw-abs':api.invalidCompAbs,//检查项-机构-不合格项-绝对值
        //'frw-trend':api.invalidCompTrend,//检查项-机构-不合格项-趋势
        //'dep-abs':api.invalidDepAbs,//检查项-部门-不合格项-绝对值
        //'dep-trend':api.invalidDepTrend,//检查项-部门-不合格项-趋势
        //'equip-abs':api.invalidEquipAbs,//检查项-设备设施-不合格项-绝对值
        //'equip-trend':api.invalidEquipTrend,//检查项-设备设施-不合格项-趋势
        'frw-abs':api.poolUnitAbsByComp,//检查项-机构-不合格项-绝对值
        'frw-trend':api.poolUnitTrendByComp,//检查项-机构-不合格项-趋势
        'dep-abs':api.poolUnitAbsByDep,//检查项-部门-不合格项-绝对值
        'dep-trend':api.poolUnitTrendByDep,//检查项-部门-不合格项-趋势
    };
    ...
    var opt = {
        ...
        methods:{
            ...
            chartClick:function(params){
                ...
                // _.extend(qryParam,{
                //     'criteria.strsValue.item':["checkItem","1"]
                // });
                // var tableOpt = {
