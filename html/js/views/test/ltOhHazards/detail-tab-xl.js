define(function(require){
	...
	var detail = LIB.Vue.extend({
		...
		methods:{
			...
			doShowLtOhHazardsFormModal4Update : function(data) {
				this.formModel.ltOhHazardsFormModel.show = true;
				this.$refs.ltohhazardsFormModal.init("update", {id: this.mainModel.vo.id});
			},
			doUpdateLtOhHazards : function(data) {
				this.doUpdate(data);
			},
