		...
		fileModel:{
			file1 : {
				cfg: {
					params: {
						recordId: null,
						dataType: 'LTTSPJ1', // 文件关联的业务对象的类型标识，需要根据数据库的注释进行对应的修改
						fileType: 'LTTSPJ'    // 文件类型标识，需要根据数据库的注释进行对应的修改
					},
					filters: {
						max_file_size: '10mb',
					},
            ...
            file2 : {
                cfg: {
                    params: {
                        recordId: null,
                        dataType: 'LTTSPJ2', // 文件关联的业务对象的类型标识，需要根据数据库的注释进行对应的修改
                        fileType: 'LTTSPJ'    // 文件类型标识，需要根据数据库的注释进行对应的修改
                    },
                    filters: {
                        max_file_size: '10mb',
            ...
            file3 : {
                cfg: {
                    params: {
                        recordId: null,
                        dataType: 'LTTSPJ3', // 文件关联的业务对象的类型标识，需要根据数据库的注释进行对应的修改
                        fileType: 'LTTSPJ'    // 文件类型标识，需要根据数据库的注释进行对应的修改
                    },
                    filters: {
                        max_file_size: '10mb',
