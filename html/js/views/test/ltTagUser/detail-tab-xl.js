define(function(require){
	...
	var dataModel = {
		mainModel : {
	        ...
	        rules:{
				...
				"user.id" : [LIB.formRuleMgr.require("员工")],
	        }
		},
		tableModel : {
		},
	...
	var detail = LIB.Vue.extend({
		...
		methods:{
			...
			doShowLtTagUserFormModal4Update : function(data) {
				this.formModel.ltTagUserFormModel.show = true;
				this.$refs.lttaguserFormModal.init("update", {id: this.mainModel.vo.id});
			},
			doUpdateLtTagUser : function(data) {
				this.doUpdate(data);
			},
