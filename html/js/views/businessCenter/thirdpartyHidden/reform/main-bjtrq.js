...
//            	}
            ...
            doReformFail: function () {
                ...
                var row = rows[0];
                if(new Date(row.createDate) < new Date("2017.08.26")) {
                	LIB.Msg.warning("旧数据无法走整改受阻流程！");
                    return;
                }
        ...
        route: {
            activate: function (transition) {
                ...
                if(queryObj.id && queryObj.method == "detail" && queryObj.opt =="isClickPoolReformExecutBtn"){
                	this.detailModel.show = true;
