define(function(require){
	...
	var detail = LIB.Vue.extend({
		...
		methods:{
			...
			doShowTechArticleFormModal4Update : function(data) {
				this.formModel.techArticleFormModel.show = true;
				this.$refs.techarticleFormModal.init("update", {id: this.mainModel.vo.id});
			},
			doUpdateTechArticle : function(data) {
				this.doUpdate(data);
			},
