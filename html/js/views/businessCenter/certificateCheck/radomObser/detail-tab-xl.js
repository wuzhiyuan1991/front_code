define(function(require){
	...
	var detail = LIB.Vue.extend({
		...
		components : {
			...
			"radomobserFormModal":radomObserFormModal,
		...
		methods:{
			...
			doShowRadomObserFormModal4Update : function(data) {
				this.formModel.radomObserFormModel.show = true;
				this.$refs.radomobserFormModal.init("update", {id: this.mainModel.vo.id});
			},
			doUpdateRadomObser : function(data) {
				this.doUpdate(data);
			},
