define(function(require) {
    ...
    var dataModel = {
        ...
        tableModel: {
            adminModel: {
                url: 'bizuserrel/list/{curPage}/{pageSize}?type=3',
                columns:  [
                    {
                        title: "人员名称",
                        fieldName: "user.name"
            ...
            remindModel: {
                url: 'remindset/list/{curPage}/{pageSize}?remindType=3',
                columns: [
                    {
                        title: "提醒周期",
        ...
        methods: {
            ...
            doSaveAdmins: function (rows) {
                ...
                var params = _.map(rows, function (row) {
                    return {
                        ...
                        orgId: row.orgId,
                        compId: row.compId,
                        type: '3' // 1 课程管理员 2 人员证书管理员 3企业证书管理员
                    }
                });
            ...
            _init: function () {
                ...
                api.querySendNotice().then(function (res) {
                    _this.lookup = _.find(_.get(res.data, "[0].lookupItems"), "name", "itm_org_cert_expire");
