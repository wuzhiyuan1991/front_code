define(function(require) {
    ...
    var remindFormModal = require("./dialog/remindFormModal");
    ...
    var dataModel = {
        ...
        tableModel: {
            adminModel: {
                url: 'bizuserrel/list/{curPage}/{pageSize}?type=1',
                columns:  [
                    {
                        title: "人员名称",
                        fieldName: "user.name"
            ...
            remindModel: {
                url: 'remindset/list/{curPage}/{pageSize}?remindType=1',
                columns: [
                    {
                        title: "提醒周期",
        ...
        methods: {
            ...
            _init: function () {
                ...
                api.querySendNotice().then(function (res) {
                    _this.lookup = _.find(_.get(res.data, "[0].lookupItems"), "name", "itm_retrain");
