define(function (require) {
            ...
            tableModel: LIB.Opts.extendMainTableOpt(
                {
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            popFilterEnum: [{id: '2', value: '面授'}, {id: '3', value: '实操'}],
                            width: 100
                        },
                        {
                            //培训人数
                    ...
                    defaultFilterValue: {"criteria.intsValue.courseType": [2, 3]}
                }
            ),
            detailModel: {
                show: false
    ...
    var vm = LIB.VueEx.extend({
        ...
        methods: {
            doTrainAgain: function () {
                this.trainAgain.visible = true;
            },
            doSaveRetrainPlan: function () {
                this.trainAgain.visible = false;
