            ...
            tableModel: LIB.Opts.extendMainTableOpt(
                {
                    ...
                    defaultFilterValue: { "criteria.orderValue": { fieldName: "endTime", orderType: "1" }, "criteria.intValue": {isEmer: isEmer} }
                }
            ),
            detailModel: {
                show: false,
    ...
    var vm = LIB.VueEx.extend({
        ...
        init: function () {
            ...
            if(this.$route.path.indexOf("/emer") == 0) {
                this.$api = require("../../emerMa/trainingRecord/vuex/api");
                isEmer = 1;
                this.isEmer = true;
            } else{
                this.$api = api;
