        ...
        methods:{
            doSave:function(){
                ...
                this.$refs.ruleform.validate(function (valid) {
                    if (valid) {
                        var resultState = _.pick(_this.mainModel.vo,"id","emergencyPlan","residualRiskEvaluationRank","preventionPerson","preventionDepartment","riskAnalysis","activityContent","activityName","activityType","devicePart","deviceName","hazard","hazardousElementsContent","introducer","subIntroducer","areas","areaType","hazardousElementsSenior","hazardousElementsJunior","scene","riskLevel","controlMeasures","checkItem","riskTypeId","hazardFactor","state","orgId","riskModelId","residualRiskModelId","checkFrequency","positionId","controlHierarchy","markup","poolId","isRotationRisk","typeOfCtrlMeas","hierOfCtrlMeas","scoreOfCtrlMeas","levelOfControl");
