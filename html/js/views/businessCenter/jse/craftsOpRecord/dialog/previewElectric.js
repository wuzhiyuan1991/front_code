        ...
        computed: {
            ...
            dispatchTime: function () {
                if(this.vo.dispatchTime){
                    return new Date(this.vo.dispatchTime).Format("yyyy年MM月dd日hh时mm分");
                }else{
                    return "  年  月  日  时  分";
                }
            ...
            beginOpTime:function(){
                if(this.items[0] && this.items[0].operateTime){
                    return new Date(this.items[0].operateTime).Format("yyyy年MM月dd日hh时mm分");
                }else{
                    return "  年  月  日  时  分";
                }
            ...
            endOpTime:function(){
                if(this.items.length > 0 && this.items[this.items.length-1].operateTime){
                    return new Date(this.items[this.items.length-1].operateTime).Format("yyyy年MM月dd日hh时mm分");
                }else{
                    return "  年  月  日  时  分";
                }
            }
