define(function(require){
    ...
    var customActions = {
        ...
        saveOpCraftsProcess : {method: 'POST', url: 'optask/{id}/opcraftsprocess'},
        removeOpCraftsProcesses : _.extend({method: 'DELETE', url: 'optask/{id}/opcraftsprocesses'}, apiCfg.delCfg),
        updateOpCraftsProcess : {method: 'PUT', url: 'optask/{id}/opcraftsprocess'},
