define(function(require){
    ...
    var opStdStepItemFormModal = require("./dialog/opStdStepItemFormModal");
	...
	var dataModel = {
		mainModel : {
            ...
            rules: {
                ...
                "attr2":[LIB.formRuleMgr.require("编码前缀字母")],
                "name" : [
                ...
                "dispatcherName":[ LIB.formRuleMgr.require("发令人姓名"),LIB.formRuleMgr.length(100)],
                "receiverName":[ LIB.formRuleMgr.require("受令人姓名"),LIB.formRuleMgr.length(100)],
                "dispatchTime":[ LIB.formRuleMgr.require("发令时间")]
            },
			emptyRules: {}
		},
		groupColumns : [
	...
	var detail = LIB.Vue.extend({
		...
		methods:{
            ...
            // 预览
            doPreview: function () {
				this.$emit("do-preview", {id:this.mainModel.vo.id});
            },
            ...
            doShowOpCardSelectModal: function () {
                this.selectModel.cardSelectModel.filterData = {orgId: this.mainModel.vo.orgId,specialityType: "6"};
