define(function(require){
	...
	var jsaMasterNewFormModal = require("componentsEx/formModal/jsaMasterNewFormModal");
	...
	var dataModel = {
		...
		formModel : {
			...
			jsaMasterNewFormModel : {
				show : false,
				queryUrl : "jsamasternew/{id}"
			}
		},
		cardModel : {
	...
	var detail = LIB.Vue.extend({
		...
		components : {
			...
			"jsamasternewFormModal":jsaMasterNewFormModal,
		...
		methods:{
			...
			doShowJsaMasterNewFormModal4Update : function(data) {
				this.formModel.jsaMasterNewFormModel.show = true;
				this.$refs.jsamasternewFormModal.init("update", {id: this.mainModel.vo.id});
			},
			doUpdateJsaMasterNew : function(data) {
				this.doUpdate(data);
			},
