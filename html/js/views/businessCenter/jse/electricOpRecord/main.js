...
//  var detailPanel = require("./detail-tab-xl");
    var previewElectricModal = require("./dialog/previewElectric");
    //导入
            ...
            tableModel: LIB.Opts.extendMainTableOpt(
                {
                    ...
                    defaultFilterValue : {"orgId" : LIB.user.orgId,"bizType":"electric","disable":2}
                }
            ),
            detailModel: {
                show: false
    ...
    var vm = LIB.VueEx.extend({
        ...
        components: {
            ...
            "previewElectricModal": previewElectricModal,
        },
        computed: {
            showSubmit: function () {
        ...
        methods: {
            ...
            doPreview: function (data) {
                ...
                this.previewModel.id = data ? data.id : _.get(this.tableModel.selectedDatas, '[0].id');
            },
            doPreviewElectric: function(){
                this.previewModel.visible = false;
                this.previewElectricModal.id= this.previewModel.id;
                this.previewElectricModal.showSignature = this.previewModel.previewType === '1';
                this.previewElectricModal.visible = true;
            },
