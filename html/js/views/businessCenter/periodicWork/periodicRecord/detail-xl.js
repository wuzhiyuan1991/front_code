define(function (require) {
    ...
    //input弹窗选人
    var checkTaskSelectModal = require("./dialog/checkTaskSelectModal");
                ...
                render: function (data) {
                    if (data.checkResult === '1') {
                        ...
                        if(parseInt(data.failedNum)>1){
                            ...
                            return '<a style="color:#f00;display: flex;align-items: center;">不合格'+str+'</a>';
                        }
                        return '<a style="color:#f00;">不合格</a>';
                ...
                api.getCheckTable({id: id}).then(function (data) {
                    ...
                    _.each(_list, function (checkItemGroup) {
                        _.each(checkItemGroup.itemList, function (checkItem) {
                            ...
                            checkItem.checkObjectName = null;
                            ...
                            checkRecord["checkObjId"] = id;
                            checkRecord['checkObjType'] = "1";
