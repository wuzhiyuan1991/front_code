define(function (require) {
    ...
    return Vue.extend({
        ...
        computed:{
            getGasInspector: function () {
                var _this = this;
                
                if(this.model.gasDetectionPersonnelId && this.model.workTpl.enableGasDetectionSigner=='1') {
                    var obj = _.find(this.model.workPersonnels, function (item) {
                        return item.id == _this.model.gasDetectionPersonnelId
                    });
                    return obj.signCatalog.name;
                }
                return this.model.gasInspector.name
            },
        ...
        data: function () {
            return {
                enableGasDetectionNotice:false,
                enableGasDetectionInCycle:false,
                imageBox:null,
                updateNum:0,
                gasTypeList:[],
                tableModel:{
