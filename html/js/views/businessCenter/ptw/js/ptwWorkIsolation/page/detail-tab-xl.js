define(function(require){
	...
	var detail = LIB.Vue.extend({
		...
		methods:{
			...
			doShowPtwWorkIsolationFormModal4Update : function(data) {
				this.formModel.ptwWorkIsolationFormModel.show = true;
				this.$refs.ptwworkisolationFormModal.init("update", {id: this.mainModel.vo.id});
			},
			doUpdatePtwWorkIsolation : function(data) {
				this.doUpdate(data);
			},
