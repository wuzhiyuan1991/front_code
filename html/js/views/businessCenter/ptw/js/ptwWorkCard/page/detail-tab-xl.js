define(function(require){
	...
	var detail = LIB.Vue.extend({
		...
		methods:{
			...
			doShowPtwWorkCardFormModal4Update : function(data) {
				this.formModel.ptwWorkCardFormModel.show = true;
				this.$refs.ptwworkcardFormModal.init("update", {id: this.mainModel.vo.id});
			},
			doUpdatePtwWorkCard : function(data) {
				this.doUpdate(data);
			},
