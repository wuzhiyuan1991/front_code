define(function(require){
    ...
    var customActions = {
        ...
        deleteByIds:{method: 'DELETE', url: 'ptwworkcard/ids'},
        ...
        updateStatusStop:{method:"PUT", url:'ptwworkcard/suspend'},
        updateStatusStopIds:{method: "PUT", url:'ptwworkcard/suspendBatch'},

        savePtwDelegateRecord:{method:"POST", url:"ptwworkpermit/{id}/ptwdelegaterecord"},
        queryCountersignroles:{method:"GET", url:"ptwworkpermit/countersignroles/mine"},
