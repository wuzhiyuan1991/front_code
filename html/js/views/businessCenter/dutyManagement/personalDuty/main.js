    ...
    var initDataModel = function () {
        return {
            ...
            mainModel: {
				...
				dutyStatistics: {ForTheSuccession: null, InTheDuty: null}
            },
            tableModel: LIB.Opts.extendMainTableOpt(
	            {
					...
					defaultFilterValue : {"criteria.strValue" : {todoReceiver : LIB.user.id}, 'criteria.orderValue':{orderType:'1', fieldName:'e.date_duty desc,e.org_id'}},
	            }
            ),
            detailModel: {
                show: false
...
//			}
			...
			dutyStatistics: function() {
				var _this = this;
                var obj = _.clone(this.$refs.mainTable.getCriteria());
                obj['criteria.strValue'] = JSON.stringify({todoReceiver:LIB.user.id});

                api.dutyStatisticsApi(obj).then(function(res) {
