            ...
            tableModel: LIB.Opts.extendMainTableOpt(
	            {
					...
					defaultFilterValue : {"criteria.strValue" : {todoHandler : LIB.user.id}, 'criteria.orderValue':{orderType:'1', fieldName:'e.date_duty desc,e.org_id'}},
...
//			}
            ...
            dutyStatistics: function() {
                ...
                obj['criteria.strValue'] = JSON.stringify({todoHandler:LIB.user.id});
