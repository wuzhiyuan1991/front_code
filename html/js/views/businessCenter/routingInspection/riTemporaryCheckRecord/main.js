    ...
    var initDataModel = function () {
        return {
            ...
            tableModel: LIB.Opts.extendMainTableOpt(
	            {
	                url: "richeckrecord/list{/curPage}{/pageSize}?type=1",
	                selectedDatas: [],
	                columns: [
                    ...
                    defaultFilterValue: {"criteria.orderValue": {fieldName: "checkEndDate", orderType: "1"},"orgId": LIB.user.orgId,"type" : 1,}
	            }
            ),
            detailModel: {
                show: false
            ...
            exportDetailModel : {
            	 url: "/richeckrecord/{id}/temporary/exportExcel"
            }
        };
    }
    ...
    var vm = LIB.VueEx.extend({
        ...
        methods: {
            doExportExcelDetail: function () {
                ...
                window.open(this.exportDetailModel.url.replace("\{id\}", rows[0].id));
            },
        },
        ready: function () {
