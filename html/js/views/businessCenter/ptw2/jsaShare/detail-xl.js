define(function(require){
	...
	LIB.registerDataDic("iptw_jsa_master_type", [
		["1","内部单位"],
		["2","承包商单位"]
	]);
	...
	var dataModel = {
		mainModel : {
	        ...
	        rules:{
				...
				"constructionOrgId": [LIB.formRuleMgr.require("作业单位"), LIB.formRuleMgr.length(100)],
	...
	var detail = LIB.Vue.extend({
		...
		methods:{
			...
			afterDoCopy:function(data) {
					//跳转
					var router = LIB.ctxPath("/html/main.html#!");
					var routerPart = "/jsa/businessCenter/ptwJsa?method=detail&id=" + data.id + "&code=" + data.code;
			...
			afterInitData : function() {
				...
				this.mainModel.vo.workCard.code = this.mainModel.vo.taskLicense;
			},
			beforeInit : function() {
				this.beforeValues = [];
				this.middleValues = [];
