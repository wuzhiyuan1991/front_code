    ...
    var detail = LIB.Vue.extend({
        ...
        computed: {
            getItemList: function () {
                if (this.mainModel.vo.attr1 === '1' && this.mainModel.vo.enableReservation === '1') {
                    return [
                        {name: "作业预约", index: 1, num: 1},
                        {name: "作业审核", index: 2, num: 2},
                        {name: "申请作业票", index: 3, num: 3},
                        {name: "现场核对", index: 4, num: 4},
                        {name: "作业会签", index: 5, num: 5},
                        {name: "作业批准", index: 6, num: 6},
                        {name: "作业监测", index: 7, num: 6},
                        {name: "作业关闭", index: 8, num: 7},
                    ]
                } else if (this.mainModel.vo.attr1 === '1' && this.mainModel.vo.enableReservation === '0') {
                    return [
                        {name: "作业预约", index: 1, num: 1},
                        {name: "作业审核", index: 2, num: 1},
                        {name: "申请作业票", index: 1, num: 1},
                        {name: "现场核对", index: 4, num: 2},
                        {name: "作业会签", index: 5, num: 3},
                        {name: "作业批准", index: 6, num: 4},
                        {name: "作业监测", index: 7, num: 4},
                        {name: "作业关闭", index: 8, num: 5},
                    ]
                }
                if (this.mainModel.vo.attr1 === '0' && this.mainModel.vo.enableReservation === '1') {
                    return [
                        ...
                        {name: "作业会签", index: 5, num: 5},
                        {name: "作业批准", index: 6, num: 6},
                        {name: "作业监测", index: 7, num: 7},
                        {name: "作业关闭", index: 8, num: 8},
                    ]
                    ...
                    return [
                        ...
                        {name: "作业会签", index: 5, num: 3},
                        {name: "作业批准", index: 6, num: 4},
                        {name: "作业监测", index: 7, num: 5},
                        {name: "作业关闭", index: 8, num: 6},
                    ]
                }
		...
		methods:{
            ...
            doDelete: function() {
                ...
                var _vo = {id:this.mainModel.vo.id,orgId:LIB.user.orgId};
                var _this = this;
                LIB.Modal.confirm({
                    title: '删除当前数据?',
                    onOk: function() {
            ...
            showApprovalModel: function (vo) {
                ...
                var _this = this;
                if ((this.mainModel.vo.attr1 == 1 && this.mainModel.vo.status == 5) || this.mainModel.vo.status == 6) {
            ...
            afterInitData: function () {
                ...
                if (this.isShowBtn && ((this.mainModel.vo.attr1 == 1 && this.mainModel.vo.status == 5) || this.mainModel.vo.status == 6)) {
                    api.checkAuthoriser({id: this.mainModel.vo.id}).then(function (res) {
                ...
                if(this.mainModel.vo.status>=3){//表示已经填报了
                    ...
                    api.queryWorkPermits({id:_this.mainModel.vo.id}).then(function (res) {
                        _this.mainModel.versionPermitList=res.data;
                        if(res.data[0]){
                            _this.$nextTick(function () {
                                if(res.data[0].id=== _this.mainModel.versionPermitId){
                    ...
                    this.showOrder= vo.status<3||(vo.status==11||!vo.workPermit.cardTplId&&vo.enableReservation);
            ...
            doPreview:function () {
                ...
                // console.log( vo.workPermit.cardTplId , vo.enableReservation)
