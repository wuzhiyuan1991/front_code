define(function(require){
	...
	var dataModel = {
		...
		formModel : {
			...
			gasDetectionRecordFormModel : {
				show : false,
				queryUrl : "gasdetectionrecord/{id}"
			}
		},
		cardModel : {
			gasDetectionDetailCardModel : {
				showContent : true
			},
		},
		selectModel : {
	...
	var detail = LIB.Vue.extend({
		...
		methods:{
			...
			doShowGasDetectionRecordFormModal4Update : function(data) {
				this.formModel.gasDetectionRecordFormModel.show = true;
				this.$refs.gasdetectionrecordFormModal.init("update", {id: this.mainModel.vo.id});
			},
