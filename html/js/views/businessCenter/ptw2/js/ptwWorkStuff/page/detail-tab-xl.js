define(function(require){
	...
	var detail = LIB.Vue.extend({
		...
		methods:{
			...
			doShowPtwWorkStuffFormModal4Update : function(data) {
				this.formModel.ptwWorkStuffFormModel.show = true;
				this.$refs.ptwworkstuffFormModal.init("update", {id: this.mainModel.vo.id});
			},
			doUpdatePtwWorkStuff : function(data) {
				this.doUpdate(data);
			},
