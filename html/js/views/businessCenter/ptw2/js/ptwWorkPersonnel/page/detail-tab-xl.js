define(function(require){
	...
	var detail = LIB.Vue.extend({
		...
		methods:{
			...
			doShowPtwWorkPersonnelFormModal4Update : function(data) {
				this.formModel.ptwWorkPersonnelFormModel.show = true;
				this.$refs.ptwworkpersonnelFormModal.init("update", {id: this.mainModel.vo.id});
			},
			doUpdatePtwWorkPersonnel : function(data) {
				this.doUpdate(data);
			},
