define(function(require){
	...
	var dataModel = {
		mainModel : {
	        ...
	        rules:{
				...
				"superviseSite" : [LIB.formRuleMgr.length(200)],
				"superviseTime" : [LIB.formRuleMgr.allowStrEmpty],
	...
	var detail = LIB.Vue.extend({
		...
		methods:{
			...
			doShowSuperviseRecordFormModal4Update : function(data) {
				this.formModel.superviseRecordFormModel.show = true;
				this.$refs.superviserecordFormModal.init("update", {id: this.mainModel.vo.id});
			},
