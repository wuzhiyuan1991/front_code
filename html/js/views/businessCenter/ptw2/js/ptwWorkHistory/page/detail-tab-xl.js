define(function(require){
	...
	var detail = LIB.Vue.extend({
		...
		methods:{
			...
			doShowPtwWorkHistoryFormModal4Update : function(data) {
				this.formModel.ptwWorkHistoryFormModel.show = true;
				this.$refs.ptwworkhistoryFormModal.init("update", {id: this.mainModel.vo.id});
			},
			doUpdatePtwWorkHistory : function(data) {
				this.doUpdate(data);
			},
