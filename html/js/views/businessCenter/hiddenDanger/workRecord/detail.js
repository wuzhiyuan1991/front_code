	...
	var dataModel = {
		mainModel : {
	        ...
	        rules:{
				...
				"user.id" : [LIB.formRuleMgr.require("上传人")],
	        }
		},
		tableModel : {
		},
        ...
        fileModel:{
            default : {
                cfg: {
                    params: {
                        recordId: null,
                        dataType: 'WR1', // 文件关联的业务对象的类型标识，需要根据数据库的注释进行对应的修改
                        fileType: 'WR'    // 文件类型标识，需要根据数据库的注释进行对应的修改
                    }
                },
                data : []
            }
	...
	var detail = LIB.Vue.extend({
		...
		methods: {
            ...
            afterInit: function (c, o) {
                if (o.opType === "create") {
                    this.mainModel.vo.uploadDate = (new Date()).Format("yyyy-MM-dd hh:mm:ss");
