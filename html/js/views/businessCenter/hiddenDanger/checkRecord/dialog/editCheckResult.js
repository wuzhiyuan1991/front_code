...
//            legalRegulation: {id: '', name: ''}
    ...
    var uploadEvents = {
        ...
        rightPic: function (file, rs) {
            dataModel.mainModel.vo.rightPictures.push(LIB.convertFileData(rs.content));
        },
        //视频
        wrongPic: function (file, rs) {
            dataModel.mainModel.vo.wrongPictures.push(LIB.convertFileData(rs.content));
        }
    };
    //数据模型
    var dataModel = {
...
//            },
            ...
            rightPic: function (data) {
                LIB.Msg.info("上传成功");
                dataModel.mainModel.vo.rightPictures.push(LIB.convertFileData(data.rs.content));
            },
            //视频
            wrongPic: function (data) {
                dataModel.mainModel.vo.wrongPictures.push(LIB.convertFileData(data.rs.content));
                LIB.Msg.info("上传成功");
