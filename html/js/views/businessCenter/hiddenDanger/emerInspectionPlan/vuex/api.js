define(function(require){
    ...
    var customActions = {
        ...
        invalidUserTask:{method: 'PUT', url: 'checktask/user/invalid'},
        getCheckTableAllItems: {method: 'GET', url: 'checktable/{id}'},
        getCheckTable: {method: 'GET', url: 'checktable/{id}/checkplan/{checkPlanId}'},
        saveCheckItems:{method: 'POST', url: 'checkplan/{id}/checkitems'},
        removeCheckItem: {method: 'DELETE', url: 'checkplan/{id}/checkItem'},
    };
