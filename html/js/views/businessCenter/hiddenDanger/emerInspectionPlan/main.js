define(function(require) {
    ...
    var initDataModel = function() {
        ...
        return {
            ...
            tableModel: LIB.Opts.extendMainTableOpt(renderTableModel({
                ...
                defaultFilterValue: { "criteria.orderValue": { fieldName: "modifyDate", orderType: "1" },"planType":3}
            })),
            detailModel: {
                show: false
            },
    ...
    var vm = LIB.VueEx.extend({
        ...
        ready: function () {
            ...
            if(companyBusinessSetState['common.enableCheckLevel'] == null ? false : companyBusinessSetState['common.enableCheckLevel'].result === '2'){
