define(function (require) {
    ...
    var checkItemSelectModal = require("./checkItem");
    ...
    var opts = {
        ...
        methods: {
            ...
            doSave: function () {
                ...
                // this.checkItemSelectModel.checkTableId = this.checkTableModel.selectedDatas[0].id;
                // this.checkItemSelectModel.visible = true;
                this.$emit("do-save", {
            ...
            doSaveCheckItem: function(data){
                this.checkItemSelectModel.visible = false;
                this.$emit("do-save", {
                    checkObj: this.mainModel.selectedDatas[0],
                    checkTable: this.checkTableModel.selectedDatas[0],
                    checkObjType: this._getCheckObjectType(),
            ...
            init: function () {
                ...
                this.updateColumns();
                var bizType = this.bizType = this.$route.query.bizType;
                if(!bizType) {
                    this.checkedType = '1';
                } else if(bizType == "equip") {
                    this.checkedType = '2';
