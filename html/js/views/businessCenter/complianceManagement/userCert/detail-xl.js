define(function(require){
	...
	var certTypeSelectModal = require("./dialog/certTypeSelectModal");
	...
	var detail = LIB.Vue.extend({
		...
		methods:{
            ...
            buildSaveData: function () {
				...
				if (!param.course.id && this.mainModel.opType !== 'create') {
					param["criteria"] = {
                        strValue: {relCourseId_empty: 1}
					};
				}
                return param;
            },
