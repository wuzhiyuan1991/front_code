define(function(require){
    ...
    var customActions = {
        ...
        getOrganizationList: {method: 'GET', url: 'organization/list'},

        getLookUpData: {method: 'GET', url: 'lookup/lookupitems/list?code=risk_map_setting'},

        getUUID: {method: 'GET', url: 'helper/getUUID'},
        updateLookUp:{method:"PUT", url:'lookupitem'},

        getCompy: {method: 'GET', url: 'riskstatic/global/map'},
