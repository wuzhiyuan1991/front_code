define(function (require) {
    var LIB = require('lib');
    var template = require("text!./main-dcjt.html");
    var Overlay = require("./helper-dcjt");
    var detailModal = require("./dialog/detail");
    var dataObj = require("./data-dcjt");
        ...
        methods: {
            ...
            _updateRiskLevel: function (data) {
                ...
                var items = _.map(data, function (item) {
                    return {
                        id: item.drawOrgId,
                        riskLevel: _.get(item, "riskFormulaBean.level", "1")
                    }
                });
                ...
                this._zoomEnd(this.map.getZoom());
                this._normalizeTreeData();
