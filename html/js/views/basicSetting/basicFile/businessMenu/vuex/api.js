define(function (require) {
    ...
    var customActions = {
        ...
        //设备设施分类
        equipmentType: {method: 'GET', url: 'equipmenttype/list?criteria.orderValue.fieldName=orderNo&criteria.orderValue.orderType=0'},
        ...
        delCertType: {method: 'DELETE', url: 'certtype'},
        createCertType: {method: 'POST', url: 'certtype'},
        updateCertType: {method: 'PUT', url: 'certtype'}
    };
