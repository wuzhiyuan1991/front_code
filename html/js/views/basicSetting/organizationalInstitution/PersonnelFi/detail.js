define(function(require) {
    ...
    var detail = LIB.Vue.extend({
        ...
        components: {
            ...
            "roleOtherSelectModal": roleSelectModal,
        },
        computed: {
            isAdmin:function(){
        ...
        methods: {
            ...
            doUpdateAtrr5:function(){
             var _this =this
                api.update(null,{id:this.mainModel.vo.id,attr5:1,compId:this.mainModel.vo.compId,orgId:this.mainModel.vo.orgId}).then(function(){
           ...
           /* doClearSelectSex:function(){
            ...
            doSaveOtherRoles: function(selectedDatas) {
                if (selectedDatas) {
                    var _this = this;
                    api.saveOtherRoles({ id: dataModel.mainModel.vo.id }, selectedDatas).then(function() {
                        api.get({ id: dataModel.mainModel.vo.id }).then(function(data) {debugger
                            dataModel.mainModel.vo.otherOrganRoleList = data.body.otherOrganRoleList;
                        });
                    });
                }
            },
            ...
            beforeInit: function(data, opType) {
                ...
                this.mainModel.vo.postList = [];
                this.mainModel.vo.hseRoleList = [];
                this.mainModel.vo.otherOrganRoleList = [];
            ...
            doDelOtherRole: function(obj) {
                var _this = this;
                var roleId = obj.entry.data.id;
                api.delOtherRole({ userId: _this.mainModel.vo.id, roleId: roleId }).then(function() {
                    LIB.Msg.info("删除角色成功！");
                    var index = -1;
                    _.each(_this.mainModel.vo.otherOrganRoleList, function(item, i) {
                        if (item.id == roleId) {
                            index = i;
                            return;
                        }
                    ...
                    if (index != -1) {
                        _this.mainModel.vo.otherOrganRoleList.splice(index, 1);
                    }
                    _this.$dispatch("ev_RefreshFinshed", _this.mainModel.vo);
                });
            },
            ...
            doAddOtherRole: function() {
                this.selectModel.roleOtherSelectModel.visible = true;
                this.selectModel.roleOtherSelectModel.filterData ={"criteria.strValue.excludCompId" : this.mainModel.vo.compId,attr1 : "1"};
            },
            //添加岗位
