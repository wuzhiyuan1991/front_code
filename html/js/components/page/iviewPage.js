define(function (require) {
    ...
    var template = '<ul :class="simpleWrapClasses" v-if="simple">' +
        '<li ' +
        ':title="$t(\'gb.common.page.previous\')" ' +
        ':class="prevClasses" ' +
        '@click="prev"> ' +
        ...
        '<slot>{{$t("gb.common.common")+ " " + total + " " + $t("gb.common.strip")}}</slot> ' +
        '</span> ' +
        '<li ' +
        'title="$t(\'gb.common.page.previous\')" ' +
        ':class="prevClasses" ' +
        ...
        '<li :title="$t(\'gb.common.page.first\')" :class="itemactive1" @click="changePage(1)"><a>1</a></li> ' +
        '<li :title="$t(\'gb.common.page.forward\')' + ' 5 ' + '$t(\'gb.common.page\')" v-if="current - 3 > 1" :class="[prefixCls + \'-item-jump-prev\']" @click="fastPrev"><a><i class="ivu-icon ivu-icon-ios-arrow-left"></i></a></li> ' +
        ...
        '<li :title="$t(\'gb.common.page.backward\')' + ' 5 ' + '$t(\'gb.common.page\')" v-if="current + 3 < allPages" :class="[prefixCls + \'-item-jump-next\']" @click="fastNext"><a><i class="ivu-icon ivu-icon-ios-arrow-right"></i></a></li> ' +
        '<li :title="$t(\'gb.common.page.last\') + allPages" v-if="allPages > 1" :class="itemactive" @click="changePage(allPages)"><a>{{ allPages }}</a></li> ' +
        '</template>' +
        '<li ' +
        'title="$t(\'gb.common.page.\')" ' +
        ':class="nextClasses" ' +
        '@click="next"> ' +
        '<a><i class="ivu-icon ivu-icon-ios-arrow-right"></i></a> ' +
        '</li> ' +
