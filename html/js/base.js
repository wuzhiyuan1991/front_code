                                    ...
                                    if (res && res.error == '0' && !!(body = res.content)) {
                                        for(cacheKey in body) {
                                            ...
                                            if(cacheKey == 'i18n') {
                                                ...
                                                base.setting.dataDic = res;
                                                window.localStorage.setItem('dataDic', JSON.stringify(base.setting.dataDicOrigin));
                                            }
                                        }
                                    }
                                    isInitFinish = true;
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.error == "0") {
                ...
                base.setting.menuList = data.content.sessionUser.menuList = JSON.parse(data.content.sessionUser.menuJsonList);
                ...
                window.enableMajorRiskSource = data.content.majordanger == 1 ? true : false;
                ...
                if (cachedOrgDataLevel !== orgDataLevel && (orgDataLevel === '50' || cachedOrgDataLevel === '50')) {
