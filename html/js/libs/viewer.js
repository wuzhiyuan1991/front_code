...
(function (global, factory) {
    ...
    var TEMPLATE = '<div class="viewer-container" touch-action="none">' + '<div class="viewer-prev-c" data-action="prev"></div><div class="viewer-next-c" data-action="next"></div>' + '<div class="viewer-canvas"></div>' + '<div class="viewer-footer">' + '<div class="viewer-navIndex"></div><div class="viewer-title"></div>' + '<div class="viewer-toolbar"></div>' + '<div class="viewer-navbar">' + '<ul class="viewer-list"></ul>' + '</div>' + '</div>' + '<div class="viewer-tooltip"></div>' + '<div role="button" class="viewer-button" data-action="mix"></div>' + '<div class="viewer-player"></div>' + '</div>';
    ...
    var methods = {
        ...
        setNavIndex: function () {
            this.navIndex.textContent = (this.index + 1) + " / " + this.length;
        },
    ...
    var Viewer = function () {
        ...
        createClass(Viewer, [{
            ...
            value: function build() {
                ...
                var navIndex = viewer.querySelector('.' + NAMESPACE + '-navIndex');
