    ...
    var detail = LIB.Vue.extend({
        ...
        methods: {
            ...
            getFactors: function(id, flag) {
                ...
                this.$api.getFactorById({ id: id, types: [1] }).then(function(data) {
                    ...
                    data.data.forEach(function(item){
                        score = LIB.numberAdd(score,item.score);
                    })
                    _this.mainModel.vo.score = score;
                    if(flag) {
                        LIB.Msg.info("刷新成功");
                    }
                })
            ...
            doOpenTabPage: function () {
                ...
                window.open("/html/main.html#!/isaAuditTableInfo?id=" + this.mainModel.vo.id)
            },
