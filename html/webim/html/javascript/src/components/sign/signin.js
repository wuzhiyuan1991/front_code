...
module.exports = React.createClass({
    ...
    componentDidMount: function () {debugger
        ...
        //因为请求方式问题 使用原生js请求
                ...
                xhr.open("GET", base.url + '/user/loginUser' ,true);
                ...
                xhr.onreadystatechange = function(){
                    ...
                    if (XMLHttpReq.readyState == 4) {
                        if (XMLHttpReq.status == 200) {
                            ...
                            var item = data.content.sessionUser.user;
                             //= data.content.faceid;
                            var username = item.mobile;
                            var auth = item.password;
                            var type = false;
                            _this.signin(username, auth, type);
                        }
                    }
                };
                xhr.send(null);
